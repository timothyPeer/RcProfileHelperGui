/*H**********************************************************************
* FILENAME :        Launcher_PRCDB100.h             DESIGN REF: 
*
* DESCRIPTION :
...
#pragma once
#ifndef LAUNCHQRC_PRCDB100_H
#define LAUNCHQRC_PRCDB100_H
#include <QObject>
#include <QRunnable>
...
class launchQRC_PRCDB100 : public QObject, public QRunnable {
	Q_OBJECT

public:
	launchQRC_PRCDB100(QObject * parent = Q_NULLPTR);
	~launchQRC_PRCDB100();
...
private:
	...
	QStringList  tables;
	QHash<QString, schemaField*> m_HashedMap_PRCDB100;
	QThreadPool * workerPool;
#include "tableEnumerations_PRCDB100.h" 

};
#endif LAUNCHQRC_PRCDB100_H
